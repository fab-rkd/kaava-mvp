        ...
        <div className="content-container py-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            ...
            <div className="sm:text-right">
              <p className="font-outfit text-base font-semibold text-white mb-4">Policies</p>
              <ul className="flex flex-col gap-2.5">
                <li>
                  <Link href="/policies/terms" target="_blank" className="text-sm font-inter text-white/70 hover:text-white transition-colors">
                    Terms &amp; Conditions
                  </Link>
                </li>
                <li>
                  <Link href="/policies/commission" target="_blank" className="text-sm font-inter text-white/70 hover:text-white transition-colors">
                    Marketplace Commission Policy
                  </Link>
                </li>
                <li>
                  <Link href="/policies/returns" target="_blank" className="text-sm font-inter text-white/70 hover:text-white transition-colors">
                    Return &amp; Refund Policy
                  </Link>
                </li>
                <li>
                  <Link href="/policies/privacy" target="_blank" className="text-sm font-inter text-white/70 hover:text-white transition-colors">
